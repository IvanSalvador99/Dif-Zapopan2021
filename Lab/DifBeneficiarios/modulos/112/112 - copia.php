<?php
    ...
    $query = "SELECT * FROM $persona_despensas_2020 WHERE idpersona = '" . $_POST['idpersona'] . "'";
    //echo "Query: " . $query . "</br>";
    if ($result = mysql_query($query, $con)) {
                ...
                <div class="row">
                    <div class="form-group has-feedback col-md-6">
                        ...
                        <select class="form-control input-sm" name="razondespensa" id="razondespensa" required>
                            ...
                            <option value="1">Registro o actualización de datos para programa de despensas municipales 2020</option>
                        </select>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 25px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
