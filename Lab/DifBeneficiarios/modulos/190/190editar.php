...
<script type="text/javascript">
            $(document).ready(function(){
                $("#tipomaltrato").on("change", function(e){
                    if ($(this).val() == "7") { // "<label for='otromaltrato' class='control-label'>Otro:</label><input type='text' class='form-control input-sm' id='otromaltrato' name='otromaltrato' pattern='^[A-Za-z0-9À-ÖØ-öø-ÿ ,.]{1,}$' data-pattern-error='Solo letras y numeros' data-required-error='Debe llenar este campo' required/><span class='glyphicon form-control-feedback' aria-hidden='true' style='margin-right: 10px'></span><div class='help-block with-errors'></div>"
                        $("#divotromaltrato").html("<label for='otromaltrato' class='control-label'>Otro:</label><input type='text' class='form-control input-sm' id='otromaltrato' name='otromaltrato' pattern='^[A-Za-z0-9À-ÖØ-öø-ÿ ,.]{1,}$' data-pattern-error='Solo letras y numeros' data-required-error='Debe llenar este campo' required/><span class='glyphicon form-control-feedback' aria-hidden='true' style='margin-right: 10px'></span><div class='help-block with-errors'></div>");
                    } else {
                        $("#divotromaltrato").empty();
                    }
                });
                
                $("#tipojuicio").on("change", function(e){
                    if ($(this).val() == "4") { // "<label for='otromaltrato' class='control-label'>Otro:</label><input type='text' class='form-control input-sm' id='otromaltrato' name='otromaltrato' pattern='^[A-Za-z0-9À-ÖØ-öø-ÿ ,.]{1,}$' data-pattern-error='Solo letras y numeros' data-required-error='Debe llenar este campo' required/><span class='glyphicon form-control-feedback' aria-hidden='true' style='margin-right: 10px'></span><div class='help-block with-errors'></div>"
                        $("#divotrotipojuicio").html("<label for='otrotipojuicio' class='control-label'>Otro:</label><input type='text' class='form-control input-sm' id='otrotipojuicio' name='otrotipojuicio' pattern='^[A-Za-z0-9À-ÖØ-öø-ÿ ,.]{1,}$' data-pattern-error='Solo letras y numeros' data-required-error='Debe llenar este campo' required/><span class='glyphicon form-control-feedback' aria-hidden='true' style='margin-right: 10px'></span><div class='help-block with-errors'></div>");
                    } else {
                        $("#divotrotipojuicio").empty();
                    }
                });
        ...
        <div>
            <h2 class="text-center">Modificación de caso</h2><br />
            <div class="text-center">
                <a target="_blank" class="btn btn-primary" id="btncerrarcaso">Cerrar caso</a>
            </div>
            <br />
            ...
            <form method="post" action="engine/engine_190.php" id="formregistrocasorep" data-toggle="validator">
                <div class="row">
                    ...
                    <div class="form-group col-md-4 has-feedback">
                        <label for="tipomaltrato" class="control-label">Tipo de Maltrato:<small> *</small></label>
                        <select class="form-control input-sm" name="tipomaltrato" id="tipomaltrato" required>
                            <option value="-1" disabled selected>---Seleccione---</option>
                            <?php echo fillSelect($tipo_maltrato);?>
                        </select>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 25px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group col-md-4 has-feedback" id="divotromaltrato">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group has-feedback col-md-4">
                        ...
                        <input class="form-control input-sm" type="text" id="delito" name="delito" pattern="^[A-Za-z0-9ñÑ ,.]{1,}$" data-pattern-error="Solo letras (sin acento), numeros, coma y punto" data-required-error="Debe llenar este campo"/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-4 has-feedback" id="divotrotipojuicio">
                    </div>
                </div>
