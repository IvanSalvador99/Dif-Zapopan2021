<?php
    ...
    $query = "SELECT * FROM $personas_ventanilla_unica WHERE idpersona = '" . $_POST['idpersona'] . "' ORDER BY id DESC LIMIT 1";
    if ($result = mysql_query($query, $con)) {
...
?>
        ...
        <div>
            <h2 class="text-center">Estudio Sociofamiliar</h2>
            <br />
            <form method="post" action="engine/engine_429.php" id="formregistroestudio" data-toggle="validator">
                <h4>Datos de identificación del beneficiario</h4>
                <div class="row">
                    <div class="form-group col-md-6 has-feedback">
                        <label for="registro">Registro:<small> *</small></label>
                        <input class="form-control input-sm caps" type="text" id="registro" name="registro" required/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group has-feedback col-md-6">
                        ...
                        <select class="form-control input-sm" name="referidopor" id="referidopor" required>
                            <?php echo fillSelectData($procedencia, $rowentrevista['procedencia']); ?>
                        </select>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 30px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                ...
                <div class="row">
                    ...
                    <?php
                        if ($rowentrevista == null) {
                            ...
                            ?>
                            <div class="form-group has-feedback col-md-3">
                                <label for="paisnacimiento" class="control-label">País:</label>
                                <select class="form-control input-sm" name="paisnacimiento" id="paisnacimiento" disabled>
                                    <?php echo fillSelectData($paises, 144); ?>
                                </select>
                                <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 30px"></span>
                                <div class="help-block with-errors"></div>
                            ...
                            <div class="form-group has-feedback col-md-3">
                                <label for="estadonacimiento" class="control-label">Estado de nacimiento:</label>
                                <input class="form-control input-sm" type="text" id="estadonacimiento" name="estadonacimiento" value="<?= $rowentrevista['estadonacimiento'] ?>" pattern="^[A-Za-z0-9À-ÖØ-öø-ÿ ,.]{1,}$" data-pattern-error="Solo letras" data-required-error="Debe llenar este campo" required disabled/>
                                <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group has-feedback col-md-3">
                                <label for="municipionacimiento" class="control-label">Municipio de nacimiento:</label>
                                <input class="form-control input-sm" type="text" id="municipionacimiento" name="municipionacimiento" value="<?= $rowentrevista['municipionacimiento'] ?>" pattern="^[A-Za-z0-9À-ÖØ-öø-ÿ ,.]{1,}$" data-pattern-error="Solo letras" data-required-error="Debe llenar este campo" required disabled/>
                                <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 30px"></span>
                                <div class="help-block with-errors"></div>
                            </div>
                            <?php
                ...
                <div class="row">
                    ...
                    <div class="form-group has-feedback col-md-3">
                        ...
                        <input class="form-control input-sm" type="text" id="tiempoestado" name="tiempoestado" maxlength="100" pattern="^[A-Za-z0-9ñÑ ,.]{1,}$" data-pattern-error="Solo letras (sin acento) y numeros, coma y punto" data-required-error="Debe llenar este campo" required/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group has-feedback col-md-12">
                        ...
                        <input type="text" class="form-control input-sm" id="apoyosolicitado" name="apoyosolicitado" maxlength="255" pattern="^[A-Za-z0-9À-ÖØ-öø-ÿ ,.]{1,}$" data-pattern-error="Solo letras y numeros" data-required-error="Debe llenar este campo" required/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group has-feedback col-md-6">
                        ...
                        <select class="form-control input-sm" name="tipovivienda" id="tipovivienda" required>
                            <option value="-1" disabled selected>---Seleccione---</option>
                            <?php echo fillSelect($tipo_vivienda); ?>
                        </select>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 30px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                ...
                <div class="row" id="rowotros" style="display: none">
                    <div class="form-group has-feedback col-md-6" id="divotrocond">
                        ...
                        <input class="form-control input-sm" type="text" id="otrocondicion" name="otrocondicion" maxlength="100" pattern="^[A-Za-z0-9ñÑ ,.]{1,}$" data-pattern-error="Solo letras (sin acento) y numeros, coma y punto" data-required-error="Debe llenar este campo"/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group has-feedback col-md-6" id="divotrotipoviv">
                        ...
                        <input class="form-control input-sm" type="text" id="otrotipovivienda" name="otrotipovivienda" maxlength="100" pattern="^[A-Za-z0-9ñÑ ,.]{1,}$" data-pattern-error="Solo letras (sin acento) y numeros, coma y punto" data-required-error="Debe llenar este campo"/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="form-group has-feedback col-md-4">
                        ...
                        <select class="form-control input-sm" name="tipoelectricidad" id="tipoelectricidad" required>
                            <option value="-1" disabled selected>---Seleccione---</option>
                            <?php echo fillSelect($electricidad); ?>
                        </select>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 30px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group has-feedback col-md-2">
                        ...
                        <input class="form-control input-sm" type="text" id="distcocina" name="distcocina" pattern="^[0-9]{1,}$" data-pattern-error="Solo numeros" data-required-error="Debe llenar este campo" required/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group has-feedback col-md-2">
                        <label for="distbano" class="control-label">Baño:<small> *</small></label>
                        <input class="form-control input-sm" type="text" id="distbano" name="distbano" pattern="^[0-9]{1,}$" data-pattern-error="Solo numeros" data-required-error="Debe llenar este campo" required/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group has-feedback col-md-2">
                        <label for="distdormitorio" class="control-label">Dormitorio:<small> *</small></label>
                        <input class="form-control input-sm" type="text" id="distdormitorio" name="distdormitorio" pattern="^[0-9]{1,}$" data-pattern-error="Solo numeros" data-required-error="Debe llenar este campo" required/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group has-feedback col-md-2">
                        <label for="distsala" class="control-label">Sala:<small> *</small></label>
                        <input class="form-control input-sm" type="text" id="distsala" name="distsala" pattern="^[0-9]{1,}$" data-pattern-error="Solo numeros" data-required-error="Debe llenar este campo" required/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group has-feedback col-md-2">
                        <label for="distcomedor" class="control-label">Comedor:<small> *</small></label>
                        <input class="form-control input-sm" type="text" id="distcomedor" name="distcomedor" pattern="^[0-9]{1,}$" data-pattern-error="Solo numeros" data-required-error="Debe llenar este campo" required/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group has-feedback col-md-2">
                        <label for="otrodistribucion" class="control-label">Otro:</label>
                        <input class="form-control input-sm" type="text" id="otrodistribucion" name="otrodistribucion" maxlength="100" pattern="^[A-Za-z0-9ñÑ ,.]{1,}$" data-pattern-error="Solo letras (sin acento) y numeros, coma y punto" data-required-error="Debe llenar este campo"/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group has-feedback col-md-4">
                        ...
                        <input class="form-control input-sm" type="text" id="limporg" name="limporg" maxlength="255" pattern="^[A-Za-z0-9À-ÖØ-öø-ÿ ,.]{1,}$" data-pattern-error="Solo letras (sin acento) y numeros, coma y punto" data-required-error="Debe llenar este campo" required/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group has-feedback col-md-6">
                            ...
                            <select class="form-control input-sm" name="tipoinmueble" id="tipoinmueble">
                                <option value="-1" disabled selected>---Seleccione---</option>
                                <?php echo fillSelect($tipo_inmueble); ?>
                            </select>
                            <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 30px"></span>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group has-feedback col-md-6">
                            ...
                            <input class="form-control input-sm" type="text" id="valorinmueble" name="valorinmueble" pattern="^[0-9]{1,}$" data-pattern-error="Solo numeros" data-required-error="Debe llenar este campo"/>
                            <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="form-group has-feedback col-md-6">
                            ...
                            <input class="form-control input-sm" type="text" id="institucioncuenta" name="institucioncuenta" maxlength="100" pattern="^[A-Za-z0-9ñÑ ,.]{1,}$" data-pattern-error="Solo letras (sin acento), coma y punto" data-required-error="Debe llenar este campo"/>
                            <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group has-feedback col-md-6">
                            <label for="valorcuenta" class="control-label">Valor de la cuenta:</label>
                            <input class="form-control input-sm" type="text" id="valorcuenta" name="valorcuenta" pattern="^[0-9]{1,}$" data-pattern-error="Solo numeros" data-required-error="Debe llenar este campo"/>
                            <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="form-group has-feedback col-md-6">
                            ...
                            <input class="form-control input-sm" type="text" id="marcavehiculo" name="marcavehiculo" maxlength="100" pattern="^[A-Za-z0-9ñÑ ,.]{1,}$" data-pattern-error="Solo letras (sin acento), coma y punto" data-required-error="Debe llenar este campo"/>
                            <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group has-feedback col-md-6">
                            <label for="modelovehiculo" class="control-label">Modelo:</label>
                            <input class="form-control input-sm" type="text" id="modelovehiculo" name="modelovehiculo" maxlength="100" pattern="^[A-Za-z0-9ñÑ ,.]{1,}$" data-pattern-error="Solo letras (sin acento), coma y punto" data-required-error="Debe llenar este campo"/>
                            <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group has-feedback col-md-6">
                            ...
                            <input class="form-control input-sm" type="text" id="institucioncredito" name="institucioncredito" maxlength="100" pattern="^[A-Za-z0-9ñÑ ,.]{1,}$" data-pattern-error="Solo letras (sin acento), coma y punto" data-required-error="Debe llenar este campo"/>
                            <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group has-feedback col-md-6">
                            <label for="saldocredito" class="control-label">Saldo:</label>
                            <input class="form-control input-sm" type="text" id="saldocredito" name="saldocredito" pattern="^[0-9]{1,}$" data-pattern-error="Solo numeros" data-required-error="Debe llenar este campo"/>
                            <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="form-group has-feedback col-md-2">
                        ...
                        <input class="form-control input-sm" type="text" id="egresoalimentos" name="egresoalimentos" value="0" pattern="^[0-9]{1,}$" data-pattern-error="Solo numeros" data-required-error="Debe llenar este campo" required/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group has-feedback col-md-2">
                        <label for="egresovivienda" class="control-label">Vivienda:<small> *</small></label>
                        <input class="form-control input-sm" type="text" id="egresovivienda" name="egresovivienda" value="0" pattern="^[0-9]{1,}$" data-pattern-error="Solo numeros" data-required-error="Debe llenar este campo" required/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group has-feedback col-md-2">
                        <label for="egresoservicios" class="control-label">Servicios:<small> *</small></label>
                        <input class="form-control input-sm" type="text" id="egresoservicios" name="egresoservicios" value="0" pattern="^[0-9]{1,}$" data-pattern-error="Solo numeros" data-required-error="Debe llenar este campo" required/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group has-feedback col-md-2">
                        <label for="egresotransporte" class="control-label">Transporte:<small> *</small></label>
                        <input class="form-control input-sm" type="text" id="egresotransporte" name="egresotransporte" value="0" pattern="^[0-9]{1,}$" data-pattern-error="Solo numeros" data-required-error="Debe llenar este campo" required/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group has-feedback col-md-2">
                        <label for="egresoeducacion" class="control-label">Educación:<small> *</small></label>
                        <input class="form-control input-sm" type="text" id="egresoeducacion" name="egresoeducacion" value="0" pattern="^[0-9]{1,}$" data-pattern-error="Solo numeros" data-required-error="Debe llenar este campo" required/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group has-feedback col-md-2">
                        <label for="egresosalud" class="control-label">Salud:<small> *</small></label>
                        <input class="form-control input-sm" type="text" id="egresosalud" name="egresosalud" value="0" pattern="^[0-9]{1,}$" data-pattern-error="Solo numeros" data-required-error="Debe llenar este campo" required/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group has-feedback col-md-2">
                        ...
                        <input class="form-control input-sm" type="text" id="egresovestido" name="egresovestido" value="0" pattern="^[0-9]{1,}$" data-pattern-error="Solo numeros" data-required-error="Debe llenar este campo" required/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group has-feedback col-md-2">
                        <label for="egresorecreacion" class="control-label">Recreación:<small> *</small></label>
                        <input class="form-control input-sm" type="text" id="egresorecreacion" name="egresorecreacion" value="0" pattern="^[0-9]{1,}$" data-pattern-error="Solo numeros" data-required-error="Debe llenar este campo" required/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group has-feedback col-md-2">
                        <label for="egresodeudas" class="control-label">Deudas:<small> *</small></label>
                        <input class="form-control input-sm" type="text" id="egresodeudas" name="egresodeudas" value="0" pattern="^[0-9]{1,}$" data-pattern-error="Solo numeros" data-required-error="Debe llenar este campo" required/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group has-feedback col-md-2">
                        <label for="egresootros" class="control-label">Otros:<small> *</small></label>
                        <input class="form-control input-sm" type="text" id="egresootros" name="egresootros" value="0" pattern="^[0-9]{1,}$" data-pattern-error="Solo numeros" data-required-error="Debe llenar este campo" required/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group has-feedback col-md-4">
                ...
                <div class="row">
                    <div class="form-group has-feedback col-md-3">
                        ...
                        <input class="form-control input-sm" type="text" id="ingresotitular" name="ingresotitular" value="0" pattern="^[0-9]{1,}$" data-pattern-error="Solo numeros" data-required-error="Debe llenar este campo"/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group has-feedback col-md-3">
                        <label for="ingresofamiliar" class="control-label">Ingreso familiar:</label>
                        <input class="form-control input-sm" type="text" id="ingresofamiliar" name="ingresofamiliar" value="0" pattern="^[0-9]{1,}$" data-pattern-error="Solo numeros" data-required-error="Debe llenar este campo" readonly/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group has-feedback col-md-3">
                        <label for="ingresootros" class="control-label">Otros:<small> *</small></label>
                        <input class="form-control input-sm" type="text" id="ingresootros" name="ingresootros" value="0" pattern="^[0-9]{1,}$" data-pattern-error="Solo numeros" data-required-error="Debe llenar este campo" required/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group has-feedback col-md-3">
                ...
                <div class="row">
                    <div class="form-group has-feedback col-md-6">
                        ...
                        <input class="form-control input-sm" type="text" id="obsbalance" name="obsbalance" maxlength="255" pattern="^[A-Za-z0-9À-ÖØ-öø-ÿ ,.]{1,}$" data-pattern-error="Solo letras (sin acento) y numeros, coma y punto" data-required-error="Debe llenar este campo"/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group has-feedback col-md-3">
                        ...
                        <select class="form-control input-sm" name="frutas" id="frutas" required>
                            <option value="-1" disabled selected>---Seleccione---</option>
                            <?php echo fillSelect($periodo_alimentos); ?>
                        </select>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 30px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                ...
                <div class="row">
                    <div class="form-group has-feedback col-md-12">
                        ...
                        <input type="text" class="form-control input-sm" id="obsalim" name="obsalim" maxlength="255" pattern="^[A-Za-z0-9À-ÖØ-öø-ÿ ,.]{1,}$" data-pattern-error="Solo letras y numeros" data-required-error="Debe llenar este campo"/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group has-feedback col-md-9">
                        ...
                        <input class="form-control input-sm" type="text" id="obssalud" name="obssalud" maxlength="255" pattern="^[A-Za-z0-9À-ÖØ-öø-ÿ ,.]{1,}$" data-pattern-error="Solo letras (sin acento), coma y punto" data-required-error="Debe llenar este campo"/>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group has-fedback col-md-12">
                        ...
                        <textarea class="form-control input-sm" form="formregistroestudio" rows="2" name="enfermedades" id="enfermedades" pattern="^[A-Za-z0-9À-ÖØ-öø-ÿ ,.]{1,}$" maxlength="255" data-pattern-error="Solo letras y numeros" data-required-error="Debe llenar este campo" required></textarea>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group has-fedback col-md-12">
                        <textarea class="form-control input-sm" form="formregistroestudio" rows="8" name="diagsfamiliar" id="diagsfamiliar" pattern="^[A-Za-z0-9À-ÖØ-öø-ÿ ,.]{1,}$" maxlength="7000" data-pattern-error="Solo letras y numeros" data-required-error="Debe llenar este campo" required></textarea>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group has-fedback col-md-12">
                        <textarea class="form-control input-sm" form="formregistroestudio" rows="8" name="planinter" id="planinter" pattern="^[A-Za-z0-9À-ÖØ-öø-ÿ ,.]{1,}$" maxlength="2000" data-pattern-error="Solo letras y numeros" data-required-error="Debe llenar este campo" required></textarea>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group has-fedback col-md-12">
                        <textarea class="form-control input-sm" form="formregistroestudio" rows="8" name="eval" id="eval" pattern="^[A-Za-z0-9À-ÖØ-öø-ÿ ,.]{1,}$" maxlength="1500" data-pattern-error="Solo letras y numeros" data-required-error="Debe llenar este campo" required></textarea>
                        <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
