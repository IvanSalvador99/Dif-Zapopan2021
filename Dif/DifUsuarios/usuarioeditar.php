<?php
    ...
    if ($_SESSION['padron_admin_permisos'] > 4 && !isset($_POST['self'])) {
        ...
        <form method="post" action="engine/engine_usuarioeditar.php" id="formeditarusuario" data-toggle="validator">
            ...
            <div class="row">
                ...
                <div class="form-group has-feedback col-md-4">
                    ...
                    <input class="form-control input-sm" type="text" id="email" name="email" value="<?=$row['email']?>" pattern="^[a-zA-Z0-9_]+(?:\.[A-Za-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?!([a-zA-Z0-9]*\.[a-zA-Z0-9]*\.[a-zA-Z0-9]*\.))(?:[A-Za-z0-9](?:[a-zA-Z0-9-]*[A-Za-z0-9])?\.)+[a-zA-Z0-9](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?$" data-pattern-error="No es un email valido" data-required-error="Debe llenar este campo" required/>
                    <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 10px"></span>
                    <div class="help-block with-errors"></div>
                </div>
                <div class="form-group has-feedback col-md-4">
                    <label for="permiso">Permisos:</label>
                        <?php
                            ...
                            $output = $output . fillSelectData($permisos, $row['permiso']);
            ...
            <div class="row">
                ...
                <div class="form-group has-feedback col-md-3">
                    ...
                    <?php
                        if ((isset($_POST['self']) && $_POST['self'] == "true") || $_SESSION['padron_admin_permisos'] > 4) {
